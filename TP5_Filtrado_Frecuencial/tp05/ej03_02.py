...
R0, nord = 50, 3
ftype = uf.BUTTERWORTH_FILTER

mag_img1, ph_img1, sh_img1 = uf.get_dft(imagen1)
params_id, is_lowpass = {"R0":R0, "n":nord}, True
filt1 = uf.butterworth_filter(imagen1.shape, params_id, is_lowpass)
...
params_id, is_lowpass = {"R0":R0, "n":nord}, False
filt2 = uf.butterworth_filter(imagen1.shape, params_id, is_lowpass)
